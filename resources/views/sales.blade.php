...
<div class="div-sm-12 hidden" id="alert">
													...
													<input type ="hidden" id="token" name="_token" value ="<?php echo csrf_token(); ?>">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6">
														   ...
														   <span class="input-icon btn-block">
                                                            ...
                                                            <div class="col-md-12">
                                                           <span class="input-icon btn-block">
                                                           <input type="button" id="pay" value="Collection" class="btn btn-danger btn-md btn-block"  data-toggle="modal" data-target="#payment">
                                                            </span>
														</div>
                                                            </div>
														</div>
